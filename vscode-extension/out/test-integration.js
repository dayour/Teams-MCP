...
exports.testChatParticipant = testChatParticipant;
const chatParticipant_1 = require("../src/chatParticipant");
...
const mockVSCode = {
    ...
    ThemeIcon: function (icon) { this.id = icon; }
};
// Mock context
const mockContext = {
    secrets: {
...
const mockChatResponse = {
    markdown: (text) => console.log(`📝 Response: ${text}`),
    progress: (text) => console.log(`⏳ Progress: ${text}`)
};
async function testChatParticipant() {
    ...
    try {
        ...
        const chatParticipant = new chatParticipant_1.TeamsChatParticipant(mockContext);
        // Test registration
